...
const RAW = {
  ...
  pagoda: `<svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor"><rect x="11" y="1.5" width="2" height="4" rx="1"/><path d="M4 8.5 12 6l8 2.5-2 2.2L12 9l-6 1.7Z"/><rect x="9.5" y="8.6" width="5" height="3" rx=".5"/><path d="M3 14 12 11l9 3-2 2.2-7-2.1-7 2.1Z"/><rect x="9" y="14" width="6" height="3.4" rx=".5"/><path d="M2 21l10-3 10 3v1H2Z"/></svg>`,
  copy: `<svg viewBox="0 0 24 24" width="1em" height="1em" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="12" height="12" rx="2"/><path d="M5 15H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v1"/></svg>`,
  people: `<svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor"><circle cx="8.5" cy="7.5" r="3.2"/><circle cx="17" cy="9" r="2.6"/><path d="M2.2 20c.4-4 2.9-6.2 6.3-6.2s5.9 2.2 6.3 6.2Z"/><path d="M15.6 13.9c2.5.3 4.4 2.1 4.8 5.1h-3.4c-.1-1.9-.6-3.6-1.4-5.1Z"/></svg>`
};
